...
originalDataPath = '/Users/Paul/Index/ReCiter/importArticlesIntoDatabase/dataOutput/' #need to modify based on your local directory
...
outputPath = '/Users/Paul/Index/ReCiter/importArticlesIntoDatabase/analysisOutput/'

#code for personArticle table
#open a csv file
f = open(outputPath + 'personArticle.csv','w')
...
for i in range(len(items)):
    ...
    for j in range(article_temp):
        ...
        f.write('"' + str(personIdentifier) + '"' + "," + '"' + str(pmid) + '"' + "," + '"' + str(totalArticleScoreStandardized) + '"' + "," 
                ...
                + '"' + str(totalArticleScoreWithoutClustering) + '"' + "," + '"' + str(clusterScoreAverage) + '"' + "," + '"' + str(clusterReliabilityScore) + '"' + "," + '"' + str(clusterScoreModificationOfTotalScore) + '"' + "," + '"' + str(clusterIdentifier) + '"' + ","
