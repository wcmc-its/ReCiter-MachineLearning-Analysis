...
path = '/Users/zhuzm1996/Desktop/s3/' #need to modify based on your local directory
...
for item in person_list:
    #record time
    start = time.time()
    for line in open(path + '{}'.format(item), 'r'): 
...
#open a csv file
f = open('personArticle_s3_mysql.csv','w')
...
f.write("personIdentifier," + "pmid," + "totalArticleScoreStandardized," + "totalArticleScoreNonStandardized," 
        ...
        + "scopusDocID," + "journalTitleVerbose," + "articleTitle," + "largeGroupAuthorship," + "feedbackScoreAccepted," + "feedbackScoreRejected," + "feedbackScoreNull," 
...
for i in range(len(items)):
    ...
    for j in range(article_temp):
        ...
        f.write(str(personIdentifier) + "," + str(pmid) + "," + str(totalArticleScoreStandardized) + "," 
                ...
                + str(scopusDocID) + ","  + '"' + str(journalTitleVerbose) + '"' + "," + '"' + str(articleTitle) + '"' + "," + str(largeGroupAuthorship) + "," + str(feedbackScoreAccepted) + "," + str(feedbackScoreRejected) + "," + str(feedbackScoreNull) + "," 
...
f = open('/Users/zhuzm1996/Desktop/ReCiter/personArticleGrant_s3.csv','w')
...
f = open('/Users/zhuzm1996/Desktop/ReCiter/personArticleScopusNonTargetAuthorAffiliation_s3.csv','w')
...
f = open('/Users/zhuzm1996/Desktop/ReCiter/personArticleScopusTargetAuthorAffiliation_s3.csv','w')
...
f = open('/Users/zhuzm1996/Desktop/ReCiter/personArticleDepartment_s3.csv','w')
...
f = open('/Users/zhuzm1996/Desktop/ReCiter/personArticleRelationship_s3.csv','w')
...
f = open('/Users/zhuzm1996/Desktop/ReCiter/personArticleAuthor_s3.csv','w')
...
f = open('/Users/zhuzm1996/Desktop/ReCiter/person_s3.csv','w')
